...
class Contato extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('nome, email, telefone', 'length', 'max' => 45),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, nome, email, telefone', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            'contatoRevenda' => array(self::HAS_MANY, 'RevendaHasContato', 'fk_contato', 'with' => 'revenda'),
        );
    }
