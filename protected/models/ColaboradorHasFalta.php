...
/**
 * This is the model class for table "colaborador_has_falta".
 *
 * The followings are the available columns in table 'colaborador_has_falta':
 * @property integer $id
 * @property string $data
 * @property integer $fk_colaborador
 * @property integer $fk_empresa
 */
class ColaboradorHasFalta extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('data, fk_colaborador, fk_empresa', 'required'),
			array('fk_colaborador, fk_empresa', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, data, fk_colaborador, fk_empresa', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ColaboradorHasFalta the static model class
	 */
