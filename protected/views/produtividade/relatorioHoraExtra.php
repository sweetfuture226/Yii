...
?>
<p><?= Yii::t("smith", 'A hora extra está sendo produtiva? Visualize aqui.') ?></p><br>
...
<div class="form-group  col-lg-4">
    <p> <?php echo CHtml::label(Yii::t("smith", 'Selecione uma opção'),'opcao'); ?>
        <?php echo CHtml::dropDownList('opcao', 'opcao',
            ...
            array('class' => 'chzn-select', 'prompt' => Yii::t("smith",'Selecione'))); ?></p>
</div>

<div class="form-group  col-lg-4" id="selec" style="display: none;">
    <p> <?php echo CHtml::label(Yii::t("smith", 'Escolha um(a)'),"colaborador_id"); ?>
        <?php echo CHtml::dropDownList('selecionado', '', array(),
            array('class' => 'chzn-select', 'id' => 'selecionado')); ?></p>
</div>
