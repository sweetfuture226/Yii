...
Yii::app()->clientScript->registerScript('button_create', '
    $(".panel-heading").prepend(\'<button class="btn btn-success" style="float: right;" onclick= location.href="'.CHtml::normalizeUrl(array("QuestaoTecnica/create")).'"><i class="icon-plus-sign"></i> Novo</button>  \');
');
...
Yii::app()->clientScript->registerScript('search', "
    ...
    $('.search-form form').submit(function(){
            $.fn.yiiGridView.update('questao-tecnica-grid', {
                    data: $(this).serialize()
            });
            return false;
    });
...
<div class="dataTables_length">
    ...
    <?php
        $this->widget('application.extensions.PageSize.PageSize', array(
                'mGridId' => 'questao-tecnica-grid', //Gridview id
