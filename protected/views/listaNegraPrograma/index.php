...
$this->breadcrumbs = array(
    Yii::t("smith", 'Programas não permitidos'),
);
...
?>
<p><?= Yii::t("smith", 'Aqui é possível adicionar um software ou site à lista de autorizados.') ?></p><br>
    <?php echo CHtml::beginForm(); ?>
    <div align="left" style="margin: 0 0 18px 10px; display: block" class="row">
        <div style="float: left; ">
            <?php echo CHtml::button(Yii::t("smith", 'Autorizar programas'), array('class' => 'btn btn-info submitForm', 'id' => 'btn_enviar', 'onclick' => "validaForm();")); ?>         
        </div>
...
<div class="dataTables_length">
    <label>
        ...
        $this->widget('application.extensions.PageSize.PageSize', array(
            'mGridId' => 'blacklist-grid', //Gridview id
    ...
    $this->widget('zii.widgets.grid.CGridView', array(
        'id' => 'blacklist-grid',
        'dataProvider' => $model->searchBlackList(),
        'filter' => $model,
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?php echo Yii::t('smith', 'Confirmar autorização de programas'); ?></h4>
                </div>
...
<script>
    function validaForm() {
        var hasItem = $.fn.yiiGridView.getChecked("blacklist-grid", "selectedItens");
