...
?>
<p><?=Yii::t("smith", 'Visualize em um gráfico de pizza o tempo dispendido em softwares e sites autorizados, softwares e sites não autorizados e tempo em que o usuário esteve fora da estação de trabalho.')?></p><br>
<div class="form-group  col-lg-4">
    <p> <?php echo CHtml::label(Yii::t("smith", 'Selecione uma opção'),'opcao'); ?>
...
<div class="form-group  col-lg-4" id="selec" style="display: none;">
    <p>
        <?php echo CHtml::label(Yii::t("smith", 'Selecione'), "colaborador_id"); ?>
