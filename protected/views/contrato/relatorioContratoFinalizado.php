...
$this->breadcrumbs = array(
    ...
    Yii::t("smith", 'Produtividade Finalizados'),
);
...
<p><?= Yii::t("smith", 'Em uma tabela detalhada, visualize a produtividade do projeto que já foi finalizado.') ?></p>
<br>
...
<div class="form-group  col-lg-8" id="selec" style="display: none ; padding-left: 0px;">
    ...
    <div class="form-group  col-lg-4">
        ...
        <?php echo CHtml::textField('date_from', '', array('class' => 'date form-control validate[required]', 'readOnly' => 'readOnly')); ?>
