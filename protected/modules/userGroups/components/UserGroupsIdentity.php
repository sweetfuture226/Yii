...
class UserGroupsIdentity extends CUserIdentity {
    ...
    public function authenticate() {
        ...
        if (!count($model))
            ...
            $this->last_change_passwd = $model->last_change_passwd;
            $this->fk_empresa = $model->fk_empresa;
            $this->serial_empresa = $model->serial_empresa;
            $this->fk_equipe = $model->fk_equipe;
            $this->recovery = false;
    ...
    public function getLastChangePasswd() {
        return $this->last_change_passwd;
    }
    ...
    function getSerial_empresa() {
        return $this->serial_empresa;
    }

    function getFk_equipe() {
