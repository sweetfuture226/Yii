...
-->
                                ...
                                <li><a href="javascript:void(0);" style="padding-left: 20px; padding-right: 0px; " >Relatório</a>
                                    <ul class="sub">
                                        ...
                                        <li>
                                            <a href="<?php //echo Yii::app()->baseUrl; ?>/logAtividade/" style="padding-left: 20px; padding-right: 0px; ">Registro de Logs</a>
                                        </li>
                                    </ul>
                                </li>
                                -->
...
<li><a href="<?php echo Yii::app()->baseUrl; ?>/ColaboradorSemProdutividade/index" style="padding-left: 20px; padding-right: 0px; ">Colaborador Sem Produtividade</a></li>
					<?php if(Yii::app()->user->groupName != "coordenador"){ ?>
                        <li><a href="<?php echo Yii::app()->baseUrl; ?>/usuario/create"
                               style="padding-left: 20px; padding-right: 0px; ">Criar Usuário</a></li>
                                        <?php } ?>
