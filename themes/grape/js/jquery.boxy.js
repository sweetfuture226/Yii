        ...
        if (node == 'a') {
            jQuery(this).click(function() {
                ...
                if (active) {
                    ...
                    boxy = new Boxy(newContent, localOptions);
...
jQuery.extend(Boxy, {
    ...
    loadImage: function(url, options) {
        var img = new Image();
        img.onload = function() {
            boxy = new Boxy($('<div class="boxy-image-wrapper"/>').append(this), options);
        };
        img.src = url;
    },
