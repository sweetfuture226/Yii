...
function adicionarProduto(tipologia_id,tipo_tipologia_id){
    ...
    var template = '\
            ...
            <div id="div_'+campo+'_'+tipologia_id+'_'+indice+'"  class="form-group col-lg-12" style="padding: 0; margin: 0 15px;">\n\
                <div class="form-group  col-lg-4">\n\
                    <label for="DecorTipologiaHasProduto['+tipologia_id+']['+indice+'][produto_id]">Produto <span class="required">*</span></label>\n\
                        <div>\n\
                            <input name="DecorTipologiaHasProduto['+tipologia_id+']['+indice+'][produto_nome]" id="DecorTipologiaHasProduto_'+tipologia_id+'_'+indice+'_produto_nome" onkeyup="buscarProduto(this.value,'+tipologia_id+','+indice+','+tipo_tipologia_id+')" class="validate[required] form-control" type="text" />\n\
                        </div>\n\
                        <input name="DecorTipologiaHasProduto['+tipologia_id+']['+indice+'][produto_id]" id="DecorTipologiaHasProduto_'+tipologia_id+'_'+indice+'_produto_id" type="hidden" class="validate[required] form-control" />\n\
                        <div id="suggestions_'+tipologia_id+'_'+indice+'"></div>\n\
                </div>\n\
                <div style="clear:both"></div>\n\
                <div class="form-group col-lg-12 produto_quantidade descricao_'+tipologia_id+'_'+indice+' invisible">\n\
                    <label for="DecorTipologiaHasProduto['+tipologia_id+']['+indice+'][quantidade]">Quantidade <span class="required">*</span></label>\n\
                    <input class="numInteiro validate[required] form-control" style="width:100%;" type="text" value="" name="DecorTipologiaHasProduto['+tipologia_id+']['+indice+'][quantidade]" id="DecorTipologiaHasProduto_'+tipologia_id+'_'+indice+'_quantidade">\n\
                </div>\n\
                ...
                <div class="form-group col-lg-12 descricao_'+tipologia_id+'_'+indice+' invisible" style="margin-bottom: 10px;">\n\
                    <label for="DecorTipologiaHasProduto['+tipologia_id+']['+indice+'][informacoes_adicionais]">Informações adicionais</label>\n\
                    <textarea cols="185" rows="6" class="form-control" style="width:100%;" type="text" value="" name="DecorTipologiaHasProduto['+tipologia_id+']['+indice+'][informacoes_adicionais]" id="DecorTipologiaHasProduto_'+tipologia_id+'_'+indice+'_informacoes_adicionais"></textarea>\n\
                </div>\n\
                <div style="clear:both"></div>\n\
                <div class="form-group col-lg-12" style="padding: 0;  margin: 0;">\n\
                    <div class="form-group col-lg-3 buttons" style="margin: 0; padding: 0 15px;">\n\
                        <div style="float: left; ">\n\
                           <input class="button btn btn-danger" style="height: 26px;" id="bt_'+tipologia_id+'_'+indice+'" onclick="removerProduto('+tipologia_id+','+indice+')" name="yt0" type="button" value="- Remover produto">\n\
                        </div>\n\
                    </div>\n\
                </div>\n\
            </div>\n\
...
function buscarProduto(inputString,tipologia_id,indice,tipo_tipologia_id){
    ...
    if(inputString.length == 0) {
        ...
        console.log(baseUrl + "/decorProduto/getProdutosDinamico");
