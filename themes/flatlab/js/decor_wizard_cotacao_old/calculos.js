...
function calcRTAcumuladaCotacao(id){
    ...
    if(isFinite(rt_acumulada)){
        $("#DecorCotacao_rt_acumulada").html('<h4>Pontuação acumulada: '+float2string(rt_acumulada)+'</h4>');
    } else {
        $("#DecorCotacao_rt_acumulada").html('<h4>RT acumulada: R$ 0,00</h4>');
    }
}
...
function calcRTAcumuladaAnaliseCotacao(id){
    ...
    if(isFinite(rt_acumulada)){
        $("#DecorCotacao_rt_acumulada").html('<h4>RT acumulada: R$ '+float2string(rt_acumulada)+'</h4>');
    } else {
        $("#DecorCotacao_rt_acumulada").html('<h4>RT acumulada: R$ 0,00</h4>');
    }
}
